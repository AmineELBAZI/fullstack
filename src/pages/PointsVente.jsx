...
import { Plus, Edit, Trash2, MapPin, Store, Search } from 'lucide-react';
...
const PointsVente = () => {
  ...
  // Nouveau : état pour la barre de recherche par boutique
  const [stockSearchTerms, setStockSearchTerms] = useState({});
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {boutiques.map(boutique => {
          ...
          const filteredStocks = boutique.stocks?.filter(stock =>
            stock.produit &&
            stock.produit.name.toLowerCase().includes((stockSearchTerms[boutique.id] || '').toLowerCase())
          ) || [];
              ...
              <div className="mt-4 bg-white rounded-xl shadow-inner p-4">
                ...
                <div className="flex items-center gap-2 mt-3 mb-2">
                  ...
                  <input
                    ...
                    value={stockSearchTerms[boutique.id] || ''}
                    onChange={e => setStockSearchTerms({
                      ...stockSearchTerms,
